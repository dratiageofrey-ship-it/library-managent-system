...
def edit_book(book_id):
    ...
    if request.method == 'POST':
        try:
            cur.execute('''
                UPDATE books
                SET title = %s, author = %s, publisher = %s, publication_year = %s, category = %s
                WHERE book_id = %s
            ''', (
                request.form['title'],
                request.form['author'],
            ...
            return render_template('edit_book.html', error=str(e))
...
def edit_member(member_id):
    ...
    if request.method == 'POST':
        try:
            ...
            return render_template('edit_member.html', error=str(e))
